...
export const getTimelineDays = (baseDate, daysCount) => Array.from({ length: daysCount }, (_, i) => {
...
export const getYearMonths = (baseDate) => Array.from({ length: 12 }, (_, i) => new Date(baseDate.getFullYear(), i, 1));

export const getDaysInMonth = (d) => new Date(d.getFullYear(), d.getMonth() + 1, 0).getDate();

export const isSameDate = (d1, d2s) => d1 && d2s && new Date(d2s).toDateString() === d1.toDateString();
