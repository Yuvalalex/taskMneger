...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "change_this_secret_key_in_production_min_32_chars"
)
...
async def create_list(
    l: CustomList, current_user: dict = Depends(get_current_user)
) -> CustomList:
    """
...
async def update_list(
    id: str, lst: CustomList, current_user: dict = Depends(get_current_user)
) -> CustomList:
    """
...
async def get_tasks(
    mode: Optional[str] = None, current_user: dict = Depends(get_current_user)
):
    tasks = []
    query = {}
